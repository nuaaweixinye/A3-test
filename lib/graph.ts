...
import { generateQuiz } from "@/lib/agents/quiz-agent";
import { generateMindmap } from "@/lib/agents/mindmap-agent";
import { generateVideo } from "@/lib/agents/video-agent";
import { generateCode } from "@/lib/agents/code-agent";
import { generateReading } from "@/lib/agents/reading-agent";
